...
public class Reader3 implements Runnable {
    ...
    private static final Logger LOGGER = Logger.getLogger(Reader3.class.getName());
    ...
    public Reader3(BlockingQueue<String> blockingQueue, ScheduledExecutorService scheduler, InstrumentRepository instrumentRepository) {
    ...
    private void processInstrumentsFromQueue() {
        ...
        IntStream.range(0, 4).forEach(x -> {
            ...
            LOGGER.info(3*timer.get() + " Redaer 3 " + value);
    ...
    private void saveInstrument(String instrument[]) {
        ...
        LOGGER.info(3*timer.get() + " " + instrument[0] + " updated");
